...
export const ASSESSMENT_TASKS: AssessmentTask[] = [
  {
    ...
    description: 'Wire Pin 14 of 7408 IC to +5V VCC, Pin 7 to GND, Pin 1 to Switch 1, Pin 2 to Switch 2, and Pin 3 to LED OUT1.',
    targetCircuitName: '7408 Logic AND Verification Circuit',
    targetIC: 'ic-7408-and',
    requiredComponents: ['trainer-board-base', 'ic-7408-and'],
    requiredConnections: [
      { fromMeta: 'trainer-board-base', fromPin: 'tb-vcc1', toMeta: 'ic-7408-and', toPin: 'pin-14' },
      { fromMeta: 'trainer-board-base', fromPin: 'tb-gnd1', toMeta: 'ic-7408-and', toPin: 'pin-7' },
      { fromMeta: 'trainer-board-base', fromPin: 'tb-in1', toMeta: 'ic-7408-and', toPin: 'pin-1' },
      { fromMeta: 'trainer-board-base', fromPin: 'tb-in2', toMeta: 'ic-7408-and', toPin: 'pin-2' },
      { fromMeta: 'ic-7408-and', fromPin: 'pin-3', toMeta: 'trainer-board-base', toPin: 'tb-out1' },
    ],
    expectedTruthTable: [
  ...
  },
  {
    ...
    description: 'Wire Pin 14 of 7400 IC to +5V VCC, Pin 7 to GND, Pin 1 to Switch 1, Pin 2 to Switch 2, and Pin 3 to LED OUT1.',
    targetCircuitName: '7400 Universal NAND Circuit',
    targetIC: 'ic-7400-nand',
    requiredComponents: ['trainer-board-base', 'ic-7400-nand'],
    requiredConnections: [
      { fromMeta: 'trainer-board-base', fromPin: 'tb-vcc1', toMeta: 'ic-7400-nand', toPin: 'pin-14' },
      { fromMeta: 'trainer-board-base', fromPin: 'tb-gnd1', toMeta: 'ic-7400-nand', toPin: 'pin-7' },
      { fromMeta: 'trainer-board-base', fromPin: 'tb-in1', toMeta: 'ic-7400-nand', toPin: 'pin-1' },
      { fromMeta: 'trainer-board-base', fromPin: 'tb-in2', toMeta: 'ic-7400-nand', toPin: 'pin-2' },
      { fromMeta: 'ic-7400-nand', fromPin: 'pin-3', toMeta: 'trainer-board-base', toPin: 'tb-out1' },
    ],
    expectedTruthTable: [
