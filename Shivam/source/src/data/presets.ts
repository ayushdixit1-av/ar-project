import { PlacedComponent, JumperWire } from '../types';
...
export const CIRCUIT_PRESETS: CircuitPreset[] = [
  {
    ...
    wires: [
      { id: 'w-ic-vcc', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-jk', toPinId: 'pin-14', color: '#ef4444' },
      { id: 'w-ic-gnd', fromComponentId: 'comp-base', fromPinId: 'tb-gnd1', toComponentId: 'comp-ic-jk', toPinId: 'pin-7', color: '#1e293b' },
      { id: 'w-clr', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-jk', toPinId: 'pin-6', color: '#ef4444' },
  ...
  },
  {
    ...
    wires: [
      { id: 'w-ic-vcc', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-d', toPinId: 'pin-14', color: '#ef4444' },
      { id: 'w-ic-gnd', fromComponentId: 'comp-base', fromPinId: 'tb-gnd1', toComponentId: 'comp-ic-d', toPinId: 'pin-7', color: '#1e293b' },
      { id: 'w-clr', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-d', toPinId: 'pin-1', color: '#ef4444' },
      { id: 'w-pr', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-d', toPinId: 'pin-4', color: '#ef4444' },
  ...
  },
  {
    ...
    wires: [
      { id: 'w-ic-vcc', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-sr', toPinId: 'pin-14', color: '#ef4444' },
      { id: 'w-ic-gnd', fromComponentId: 'comp-base', fromPinId: 'tb-gnd1', toComponentId: 'comp-ic-sr', toPinId: 'pin-7', color: '#1e293b' },
  ...
  },
  {
    ...
    wires: [
      { id: 'w-ic-vcc', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-t', toPinId: 'pin-14', color: '#ef4444' },
      { id: 'w-ic-gnd', fromComponentId: 'comp-base', fromPinId: 'tb-gnd1', toComponentId: 'comp-ic-t', toPinId: 'pin-7', color: '#1e293b' },
      { id: 'w-clr', fromComponentId: 'comp-base', fromPinId: 'tb-vcc5a', toComponentId: 'comp-ic-t', toPinId: 'pin-3', color: '#ef4444' },
