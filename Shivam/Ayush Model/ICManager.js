...
export class ICManager {
  ...
  static validate() {
    ...
    const pins = IC.footprintFor('7400', 'F', 10, 'NORMAL');
    const pins16 = IC.footprintFor('74151', 'F', 30, 'NORMAL');
    const holes = [];
    ...
    const ic = manager.place({ holes, startRow: 'F', startColumn: 10, orientation: 'NORMAL', part: '7400' });
    ...
    manager.place({ holes, startRow: 'F', startColumn: 30, orientation: 'NORMAL', part: '74151' });
