...
export class ICValidator {
  ...
  static checkOrientation(pins, orientation) {
    ...
    const expectedRow = orientation === IC.ORIENTATION.NORMAL ? IC.ROW.F : IC.ROW.E;
  ...
  static checks() {
    ...
    const part14 = '7400';
    const part16 = '74151';
    const pins14 = IC.footprintFor(part14, 'F', 10, IC.ORIENTATION.NORMAL);
    const pins16 = IC.footprintFor(part16, 'F', 10, IC.ORIENTATION.NORMAL);
    ...
    const out = IC.footprintFor(part14, 'F', 60, IC.ORIENTATION.NORMAL);
    ...
    const pinsFlip = IC.footprintFor(part14, 'E', 10, IC.ORIENTATION.FLIPPED);
